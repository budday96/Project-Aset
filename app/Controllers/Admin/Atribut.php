...
class Atribut extends BaseController
{
    public function index($idSub)
    {
        ...
        return view('admin/atribut/index', [
    ...
    public function create($idSub)
    {
        ...
        return view('admin/atribut/create', [
    ...
    public function store()
    {
        ...
        return redirect()->to(base_url('admin/atribut/' . $this->request->getPost('id_subkategori')))
    ...
    public function edit($idAtribut)
    {
        ...
        return view('admin/atribut/edit', [
            'title'        => 'Edit Atribut',
            'row'          => $row,
            'sub'          => $sub,
    ...
    public function update($idAtribut)
    {
        ...
        return redirect()->to(base_url('admin/atribut/' . $idSub))->with('success', 'Atribut diupdate.');
    }
    ...
    public function delete($idAtribut)
    {
        ...
        return redirect()->to(base_url('admin/atribut/' . $row['id_subkategori']))
