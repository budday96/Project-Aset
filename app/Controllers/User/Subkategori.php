...
class Subkategori extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('user/subkategori/index', $data);
    }
    ...
    public function trash()
    {
        ...
        return view('user/subkategori/trash', [
    ...
    {
        return view('user/subkategori/create', [
    ...
    public function store()
    {
        ...
        return redirect()->to(base_url('user/subkategori'))->with('success', 'Subkategori ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        if (!empty($row['deleted_at'])) {
            return redirect()->to(base_url('user/subkategori'))->with('error', 'Tidak bisa mengedit data yang diarsip.');
        }

        $kat = $this->katM->find((int)$row['id_kategori']);

        return view('user/subkategori/edit', [
    ...
    public function update($id)
    {
        ...
        return redirect()->to(base_url('user/subkategori'))->with('success', 'Subkategori diupdate.');
    }
    ...
    public function restore($id)
    {
        ...
        return $ok
            ? redirect()->to(base_url('user/subkategori/trash'))->with('success', 'Subkategori dipulihkan.')
    ...
    public function purge($id)
    {
        ...
        return redirect()->to(base_url('user/subkategori/trash'))->with('success', 'Subkategori dihapus permanen.');
    }
}
