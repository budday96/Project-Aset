...
class MasterAset extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('user/master_aset/index', $data);
    }
    ...
    public function trash()
    {
        ...
        return view('user/master_aset/trash', [
    ...
    public function create()
    {
        ...
        return view('user/master_aset/create', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/user/master-aset')->with('success', 'Master aset dibuat.');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$row) {
            return redirect()->to('/user/master-aset')->with('errors', 'Data tidak ditemukan');
        }
        ...
        return view('user/master_aset/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        try {
            ...
            return redirect()->to('/user/master-aset')->with('success', 'Master aset diperbarui.' . $note);
        } catch (\Throwable $e) {
            $db->transRollback();
    ...
    public function detail($id)
    {
        ...
        if (! $row) {
            return redirect()->to('/user/master-aset')
        ...
        return view('user/master_aset/detail', [
    ...
    public function delete($id)
    {
        try {
            ...
            return redirect()->to('/user/master-aset')->with('success', 'Master aset diarsipkan.');
        } catch (\Throwable $e) {
    ...
    public function restore($id)
    {
        ...
        if ($ok) {
            return redirect()->to('/user/master-aset/trash')->with('success', 'Master aset dipulihkan.');
        }
    ...
    public function purge($id)
    {
        ...
        return redirect()->to('/user/master-aset/trash')->with('success', 'Master aset dihapus permanen.');
    }
