...
class Atribut extends BaseController
{
    public function index($idSub)
    {
        ...
        return view('user/atribut/index', [
    ...
    public function create($idSub)
    {
        ...
        return view('user/atribut/create', [
    ...
    public function store()
    {
        ...
        return redirect()->to(base_url('user/atribut/' . $this->request->getPost('id_subkategori')))
    ...
    public function update($idAtribut)
    {
        ...
        return redirect()->to(base_url('user/atribut/' . $idSub))->with('success', 'Atribut diupdate.');
    }
    ...
    public function delete($idAtribut)
    {
        ...
        return redirect()->to(base_url('user/atribut/' . $row['id_subkategori']))
