...
class Aset extends BaseController
{
    ...
    public function edit($id)
    {
        ...
        if (! $row) {
            return redirect()->to('/user/aset')->with('errors', 'Data aset tidak ditemukan');
        }
        if ((int) $row['id_cabang'] !== (int) user()->id_cabang) {
            return redirect()->to('/user/aset')->with('errors', 'Akses ditolak');
        }
    ...
    public function update($id)
    {
        ...
        if (!$aset) {
            return redirect()->to('/user/aset')->with('error', 'Data aset tidak ditemukan.');
        }

        // 🔒 KUNCI CABANG
        if ((int)$aset['id_cabang'] !== (int)user()->id_cabang) {
            return redirect()->to('/user/aset')->with('error', 'Akses ditolak.');
        }
        ...
        return redirect()->to('/user/aset')->with('success', 'Aset berhasil diperbarui.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/user/aset')->with('success', 'Aset diarsipkan.');
    }
    ...
    public function trash()
    {
        ...
        return view('user/aset/trash', ['title' => 'Arsip Aset', 'items' => $items]);
    }
    ...
    public function restore($id)
    {
        ...
        return $ok
            ? redirect()->to('/user/aset/trash')->with('success', 'Aset dipulihkan.')
    ...
    public function purge($id)
    {
        ...
        return redirect()->to('/user/aset/trash')->with('success', 'Aset dihapus permanen.');
    }
