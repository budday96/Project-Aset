...
class MutasiAset extends BaseController
{
    ...
    public function store()
    {
        ...
        return redirect()->to('/user/mutasi')->with('success', 'Mutasi berhasil dibuat (pending).');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$header) {
            return redirect()->to('/user/mutasi')->with('error', 'Data mutasi tidak ditemukan.');
        }
        ...
        if (
            ...
            return redirect()->to('/user/mutasi')
    ...
    public function show($id)
    {
        ...
        if (
            ...
            return redirect()->to('/user/mutasi')->with('error', 'Akses ditolak.');
        }
        ...
        return view('user/mutasi/detail', [
    ...
    public function suratJalan($id)
    {
        ...
        return view('user/mutasi/surat_jalan', [
            'header'  => $header,
            'details' => $details,
        ]);
    }
