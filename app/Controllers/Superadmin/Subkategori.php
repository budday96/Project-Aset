...
class Subkategori extends BaseController
{
    ...
    public function trash()
    {
        ...
        return view('superadmin/subkategori/trash', [
    ...
    public function edit($id)
    {
        ...
        if (!empty($row['deleted_at'])) {
            return redirect()->to(base_url('superadmin/subkategori'))->with('error', 'Tidak bisa mengedit data yang diarsip.');
        }
    ...
    public function restore($id)
    {
        ...
        return $ok
            ? redirect()->to(base_url('superadmin/subkategori/trash'))->with('success', 'Subkategori dipulihkan.')
    ...
    public function purge($id)
    {
        ...
        return redirect()->to(base_url('superadmin/subkategori/trash'))->with('success', 'Subkategori dihapus permanen.');
    }
}
