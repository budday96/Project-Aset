...
class KelompokHarta extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('superadmin/kelompok_harta/index', [
            'items' => $items,
    ...
    public function create()
    {
        ...
        return view('superadmin/kelompok_harta/create', [
            'title' => 'Tambah Kelompok Harta',
            'action' => site_url('superadmin/kelompokharta/store'),
            'method' => 'post',
            'item' => null,
    ...
    public function store()
    {
        ...
        return redirect()->to(site_url('superadmin/kelompokharta'));
    }
    ...
    public function edit($id = null)
    {
        ...
        return view('superadmin/kelompok_harta/edit', [
            'title' => 'Edit Kelompok Harta',
            'action' => site_url("superadmin/kelompokharta/update/{$id}"),
            'method' => 'post',
            'item' => $item,
            'validation' => \Config\Services::validation()
        ]);
