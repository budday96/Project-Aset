...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <?php if (!empty($items)): ?>
                <a href="<?= site_url('user/notifikasi/read-all'); ?>"
        ...
        <ul class="nav nav-pills mb-4 gap-1" style="--bs-nav-pills-link-active-bg: #ffc107; --bs-nav-pills-link-active-color: #000;">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $filter === 'mutasi' ? 'active' : '' ?>"
                    href="<?= site_url('user/notifikasi?tipe=mutasi') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $filter === 'expired' ? 'active' : '' ?>"
                    href="<?= site_url('user/notifikasi?tipe=expired') ?>">
        ...
        <?php else: ?>
            <div class="list-group list-group-flush">
                <?php foreach ($items as $n): ?>
                    ...
                    ?>
                    <a href="<?= site_url('user/notifikasi/open/' . $n['id']) ?>"
