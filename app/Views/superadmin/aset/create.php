                    ...
                    <div class="col-md-12">
                        ...
                        <select name="id_cabang" class="form-select" required>
                            ...
                            <?php foreach ($cabangs as $c): ?>
                                <option value="<?= $c['id_cabang'] ?>" <?= old('id_cabang') == $c['id_cabang'] ? 'selected' : '' ?>><?= esc($c['nama_cabang']) ?></option>
                            <?php endforeach ?>
                        </select>
...
<script>
    $(function() {
        ...
        $('#master_aset').select2({
            ...
            ajax: {
                url: `${BASE}/superadmin/aset/getMasterAset`,
                dataType: 'json',
                delay: 250,
                processResults: data => ({
        ...
        $kat.on('change', function() {
            ...
            if (!idKat) return;
            $.ajax({
                url: `${BASE}/superadmin/master-aset/subkategori/${idKat}`,
                dataType: 'json',
