...
<div class="container-fluid px-0">
    <div class="card shadow-sm mb-4">
        <div class="card-header text-white d-flex justify-content-between align-items-center" style="background-color: #fd7e14;">
            ...
            <div>
                <a class="btn btn-light btn-sm me-2" href="<?= base_url('superadmin/master-aset/edit/' . (int)$row['id_master_aset']) ?>">
                    <i class="bi bi-pencil"></i> Edit
                </a>
                <a class="btn btn-outline-light btn-sm" href="<?= base_url('superadmin/master-aset') ?>">
