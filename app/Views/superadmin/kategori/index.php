        ...
        <div class="col-lg-12">
            <div class="card-header bg-white py-3 px-4 d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="<?= base_url('/superadmin/kategori'); ?>" class="btn btn-outline-secondary btn-sm" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Refresh">
                        <i class="bi bi-arrow-clockwise fs-5"></i>
                    </a>
                    <a class="btn btn-warning btn-sm fw-semibold d-flex align-items-center" href="<?= base_url('superadmin/kategori/create') ?>">
                        ...
                        <tbody>
                            <?php foreach ($kategoris as $i => $kategori): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('superadmin/kategori/edit/' . $kategori['id_kategori']) ?>" class="btn btn-sm btn-warning">Edit</a>
                                        <form action="<?= base_url('superadmin/kategori/delete/' . $kategori['id_kategori']) ?>" method="post" class="d-inline" onsubmit="return confirm('Yakin hapus?')">
                                            <?= csrf_field() ?>
