    ...
    <div class="card-body">
        <div class="col-lg-12">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <a href="<?= base_url('admin/aset') ?>" class="btn btn-light btn-sm">Kembali ke Daftar</a>
            </div>
            <div class="card-body">
                ...
                <div class="d-flex justify-content-start">
                    <a href="<?= base_url('admin/aset/edit/' . $aset['id_aset']) ?>" class="btn btn-warning me-2">Edit</a>
                    <form action="<?= base_url('admin/aset/delete/' . $aset['id_aset']) ?>" method="post" onsubmit="return confirm('Hapus aset ini?')">
                        <?= csrf_field() ?>
