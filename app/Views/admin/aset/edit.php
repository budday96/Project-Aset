            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="id_kategori"
                        ...
                        required>
                        <option value="" disabled <?= old('id_kategori', $aset['id_kategori']) ? '' : 'selected' ?>>-- Pilih Kategori --</option>
                        <?php foreach ($kategoris as $k): ?>
                            <option value="<?= $k['id_kategori'] ?>"
                                <?= old('id_kategori', $aset['id_kategori']) == $k['id_kategori'] ? 'selected' : '' ?>>
                                <?= esc($k['nama_kategori']) ?>
                            </option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select name="kondisi"
                        ...
                        required>
                        <option value="" disabled <?= old('kondisi', $aset['kondisi']) ? '' : 'selected' ?>>-- Pilih Kondisi --</option>
                ...
                <div class="col-md-6">
                    ...
                    <select name="status"
                        ...
                        required>
                        <option value="" disabled <?= old('status', $aset['status']) ? '' : 'selected' ?>>-- Pilih Status --</option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date"
                        name="expired_at"
                        class="form-control"
                        value="<?= old('expired_at', $aset['expired_at']) ?>">
                </div>
                ...
                <div class="col-12">
                    ...
                    <?php if (!empty($aset['gambar'])): ?>
                        <div class="mt-2">
                            <img src="<?= base_url('uploads/aset/' . $aset['gambar']) ?>" width="120" class="img-thumbnail" alt="Gambar aset">
                        </div>
                    <?php endif; ?>
                ...
                <div class="col-12">
                    ...
                    <textarea name="keterangan"
                        class="form-control"
                        rows="4"
                        placeholder="Deskripsi / detail aset"><?= old('keterangan', $aset['keterangan']) ?></textarea>
                </div>
            </div>
